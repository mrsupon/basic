                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('dashboard.profiles.update',['id'=> $users->id]) }}" enctype="multipart/form-data"  >
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="profile_image" name="profile_image" class="rounded avatar-xl" src="{{ !empty($users->profile_image)? url('backend/profiles/uploadedImages/'.$users->profile_image): url('backend/profiles/uploadedImages/no_image.jpg')  }}" alt="Image Format Error">
                                </div>
                            </div>
                            <!-- end row -->
